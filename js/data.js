...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: "An agentic AI app that turns plain-English questions into SQL, runs them against a real database, and explains the results. Upload your own SQLite file, get safety-guarded SELECT-only queries, plain-English breakdowns, and optimization tips.",
    icon: '🗄️', category: 'ai-ml', featured: false,
    tags: ['LangChain', 'Gemini 2.5 Flash', 'Streamlit'],
    grad: 'linear-gradient(135deg,#6366f1,#06b6d4)',
    link: 'https://natural-language-to-sql-query-generator-v2.streamlit.app/',
  },
  {
    title: 'PPT Builder',
    desc: 'An AI agent that generates full PowerPoint presentations from a simple prompt, using LangChain to plan slide structure and content automatically.',
    icon: '📽️', category: 'ai-ml', featured: false,
    tags: ['LangChain', 'Python', 'Streamlit'],
    grad: 'linear-gradient(135deg,#f97316,#eab308)',
    link: 'https://blazeo8-ppt-builder.streamlit.app/',
  },
  {
    title: 'EDA Agent',
    desc: 'An AI-powered exploratory data analysis agent — upload a dataset and it automatically profiles, visualizes, and surfaces insights, from basic summary stats to advanced pattern detection.',
    icon: '📈', category: 'ai-ml', featured: false,
    tags: ['Python', 'Data Analysis', 'Streamlit'],
    grad: 'linear-gradient(135deg,#10b981,#3b82f6)',
    link: 'https://github.com/BlazeO8/EDA_agent_clg',
  },
  {
    title: 'PDF Q&A Bot',
    desc: 'A RAG-powered chatbot — upload any PDF and ask questions about it in a chat interface. Answers are grounded strictly in the document via chunking, Gemini embeddings, and cosine-similarity retrieval.',
    icon: '📄', category: 'ai-ml', featured: false,
    tags: ['RAG', 'Gemini', 'Streamlit'],
    grad: 'linear-gradient(135deg,#ec4899,#8b5cf6)',
    link: 'https://blazeo8-pdf-bot.streamlit.app/',
  },
  {
    title: 'Job Finder',
    desc: 'A web app that helps users search and discover relevant job listings through a simple, streamlined interface.',
    icon: '💼', category: 'ai-ml', featured: false,
    tags: ['Python', 'Streamlit'],
    grad: 'linear-gradient(135deg,#14b8a6,#0ea5e9)',
    link: 'https://blazeo8-job-finder-cp.streamlit.app/',
  },
  {
    title: 'Flower Classification (FCR)',
    desc: 'A Streamlit app that predicts Iris flower species using six ML models (Logistic Regression, Naive Bayes, Decision Tree, Random Forest, SVM, KNN) side by side, with an interactive chart comparing predictions and a combined final vote.',
    icon: '🌸', category: 'ai-ml', featured: false,
    tags: ['scikit-learn', 'Streamlit', 'Altair'],
    grad: 'linear-gradient(135deg,#f43f5e,#fb923c)',
    link: 'https://fcr-ml-collegebased-blazeo8.streamlit.app/',
  },
  {
    title: 'Special Obby',
